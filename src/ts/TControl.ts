...
export class TControl {
  ...
  public initRaycaster(params: raycasterEventParams) {
    ...
    if (params.click) {
      this.raycasterClick = (event) => {
        ...
        this.tScene.eDispatcher.dispatchEvent({
          type: "CLICK",
      ...
      this.tScene.container.addEventListener(
        "pointerdown",
        this.raycasterClick
      );
    }
  ...
  public disposeRaycaster() {
    if (this.raycaster) {
      this.raycaster = null;
      this.tScene.container.removeEventListener(
        "pointerdown",
        this.raycasterClick
      );
      this.tScene.container.removeEventListener(
  ...
  public initPointerLock() {
    ...
    this.tScene.container.addEventListener(
      "keydown",
      this.pointerKeyDownCallback,
      false
    );
    this.tScene.container.addEventListener(
      "keyup",
      this.pointerKeyUpCallback,
      false
    );
