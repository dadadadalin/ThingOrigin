export class TIndexedDB {
     ...
     */
    public accessModel(dataBaseName: string, tableName: string, modelInfo: IDBParams): Promise<modelResultParams> {
     ...
     * @returns {*}  {Promise<object>}
     */
    public insertModel(dataBaseName: string, tableName: string, modelInfo: IDBParams): Promise<modelResultParams> {
        return new Promise((resolve) => {
     ...
     * @param {number} id
     */
    public deleteModel(dataBaseName: string, tableName: string, id: number): Promise<boolean> {
        let db = this.DBs.get(dataBaseName);
     ...
     * @param {IDBParams} modelInfo
     */
    public updateModel(dataBaseName: string, tableName: string, modelInfo: IDBParams) {
